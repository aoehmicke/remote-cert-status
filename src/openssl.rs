...
impl RemainingDays {
    pub fn new(stdout: String, stderr: String, organisation: String, host: String) -> RemainingDays {
        RemainingDays { stdout, stderr, organisation, host }
    }
...
pub fn remaining_days_cmd_output(p: path::Display, organisation: String, host: String) -> RemainingDays {
    let p = p.to_string();
    ...
    RemainingDays::new(stdout, stderr, organisation, host)
}